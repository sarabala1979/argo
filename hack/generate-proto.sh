...
IMPROT_PKG=(
    /Users/sbalasubram/go/src/github.com/argoproj/argo/vendor/k8s.io/apimachinery/pkg/apis/meta/v1
    /Users/sbalasubram/go/src/github.com/argoproj/argo/vendor/k8s.io/apimachinery/pkg/util/intstr
    /Users/sbalasubram/go/src/github.com/argoproj/argo/vendor/k8s.io/apimachinery/pkg/api/resource
   /Users/sbalasubram/go/src/ github.com/argoproj/argo/vendor/k8s.io/api/core/v1
    /Users/sbalasubram/go/src/k8s.io/apimachinery/pkg/runtime
)
...
go-to-protobuf \
    ...
    --proto-import=./vendor \
    --proto-import=$(IFS=, ; echo "${IMPROT_PKG[*]}")